          ...
          return (
            <Card style={{ width: "18rem", marginTop:'2%'}}>
              ...
              <Card.Body>
                ...
                <Button variant="">
                  <Link key={id} to={`/user/${id}`}>User Details</Link>
                </Button>
              </Card.Body>
            </Card>
          );
